                     ...
                     <!--  <h3 class="box-title">Title</h3> -->
                      <!--  <div class="box-tools pull-right">
                        ...
                        <button class="btn btn-box-tool" data-widget="remove" data-toggle="tooltip" title="" data-original-title="Remove"><i class="fa fa-times"></i></button>
                          ...
                          require_once 'db.php';
                           $sql = 'SELECT * FROM package where package_status = 1';
                           //mysql_select_db('gym');
                        ...
                        <table id="example" class="table table-bordered">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><a class="btn btn-block btn-warning btn-flat"  href="edit-package.php?id=<?php echo$row['package_id'] ?>">Edit</a></td>
                                <td><a class="btn btn-block btn-danger btn-flat" onClick="return confirm('Delete This account?')" href="delete.php?pakid=<?php echo$row['package_id'] ?>">Delete</a></td>
